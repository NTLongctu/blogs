<?php
   ...
   $sql = "SELECT blog.id AS blogid, 
         ...
         LEFT JOIN category ON category.id = blog.tag_id 
         WHERE blog.user_id = ".$_SESSION['name_id']."
         GROUP BY blogid, blogtitle, blogsub, blogdate_create, blogimg, catename ORDER BY blog.id DESC LIMIT $start, $limit";
   $myblog =$db->fetchsql($sql);
   //pagination - end
                           ...
                           <div class="col">
                              ...
                              <ul>
                                    <?php if ($current_page > 1 && $total_page > 1) {
                                             echo '<li><a href="myblogs.php?page='.($current_page-1).'">&lt;</a></li>';
                                          }
                                          for ($i = 1; $i <= $total_page; $i++){
                                             ...
                                             if ($i == $current_page){
                                                ...
                                                echo '<li><a href="myblogs.php?page='.$i.'">'.$i.'</a></li>';
                                             }
                                         }
